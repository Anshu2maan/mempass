...
window.CHAR_SETS = CHAR_SETS;
window.PIN_LENGTH = PIN_LENGTH;
window.STORAGE_KEYS = STORAGE_KEYS;
window.DOCUMENT_TYPES = DOCUMENT_TYPES;
window.COMMON_SERVICES = COMMON_SERVICES;
window.MAX_PIN_ATTEMPTS = MAX_PIN_ATTEMPTS;
window.LOCKOUT_DURATION_MIN = LOCKOUT_DURATION_MIN;
